...
public class PersonHelper {
    ...
    public PersonHelper initWrapper(Cursor cursor) {
        ...
        personUuidIdx = cursor.getColumnIndex(PersonColumns.COL_PERSON_UUID);
        emailIdx = cursor.getColumnIndex(PersonColumns.COL_EMAIL);
        // Phone
    ...
    public static ContentValues getContentValues(Person entity) {
        ...
        initialValues.put(PersonColumns.COL_PERSON_UUID, entity.personUuid);
        initialValues.put(PersonColumns.COL_EMAIL, entity.email);
        // Phone
