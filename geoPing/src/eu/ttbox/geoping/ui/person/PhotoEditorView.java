...
//    /** {@inheritDoc} */
//    @Override
//    public void setValues(DataKind kind, ValuesDelta values, EntityDelta state, boolean readOnly,  ViewIdGenerator vig) {
...
//        if (values != null) {
        	...
        	Bitmap photo =  ContactHelper.loadPhotoContact(getContext(), contactId);; 
            if (photo != null) { 
