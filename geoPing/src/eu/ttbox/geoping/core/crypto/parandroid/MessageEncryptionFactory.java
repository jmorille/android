package eu.ttbox.geoping.core.crypto.parandroid;
...
public abstract class MessageEncryptionFactory {
    ...
    public static final String KEY_EXCHANGE_PROTOCOL = "DH";
    ...
    protected static final byte[] PRIVATE_KEY_ENCRYPTION_SALT = { (byte) 0xc7, (byte) 0x73, (byte) 0x21, (byte) 0x8c, (byte) 0x7e, (byte) 0xc8, (byte) 0xee, (byte) 0x99 };

    public static String password = null;
    private static boolean isAuthenticating = false;

    /**
     * Diffie Hellman parameters P and G. Diffie-Hellman establishes a shared
     * secret that can be used for secret communications by exchanging data over
     * a public network.
     * 
    ...
    public static final BigInteger P = new BigInteger(
            "9289986504414644358097953743225136849757607686008190055292886218364533315560867997658782522702215600927448569831496872430051834791379663335482694978773549");

    /**
     * Generate a keypair using diffie - hellman The keys are saved in the
     * filesystem
     * 
     * @param context
     * @return keyPair
    ...
    /**
     * Compute a shared secret for the ENCRYPTION_ALGORITHM. This should always
     * be computed, and may never be stored.
     * 
     * @param privateKey
     * @param publicKey
     * @return secretKey
     ...
     * Hashmap with number and description
     * 
     * @param context
    ...
    /**
     * Get the local filename of a stored public key. Trailing country-codes
     * will be omitted
     * 
     * @param number
     * @return filename
    ...
    /**
     * Get a stored private key in PKCS8 format (Used to carry private
     ...
     * @throws Exception
     */
    // public static void savePublicKey(Context context, String sender, byte[]
    // key) throws Exception{
    // String publicKeyFilename = getPublicKeyFilename(context, sender);
    //
    // FileOutputStream out = context.openFileOutput(publicKeyFilename,
    ...
    public static void sendPublicKey(Context context, String number) throws IOException {
        ...
        String extraMessage = context.getString(R.string.no_geoping_description);
    ...
    /**
     * Disables the password, forcing the user to insert it again when trying to
    ...
    public static SQLiteDatabase openKeyring(Context context) {
        ...
        keyRing.execSQL("CREATE TABLE IF NOT EXISTS " + PUBLIC_KEY_TABLE + " (_ID INTEGER PRIMARY KEY, " + "number VARCHAR, " + "publicKey VARCHAR, " + "accepted BOOLEAN, "
