...
public class EntityDto {
     ...
     *
     * @param e {@link Entity} which the EntityDto will be created from.
    ...
    public String toString() {
        return new StringBuffer() //
                .append("EntityDto(" ).append( this.getKindName() ).append( '/' ) //
                .append( this.getId() ).append( "): " ).append( properties) //
                .toString();
    }
    ...
    public int hashCode() {
        String s = new StringBuffer() //
                .append(this.id).append(this.kindName).append(this.createdAt).append(this.createdBy) //
                .append(this.updatedAt).append(this.updatedBy)//
                .append(this.properties.toString()).append(this.owner) //
                .toString();
        return s.hashCode();
    }
