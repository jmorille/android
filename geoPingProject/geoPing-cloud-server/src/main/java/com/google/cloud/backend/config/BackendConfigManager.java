...
public class BackendConfigManager {
     ...
     *
     * @param datastoreService datastoreService that will be used for persistence.
     */
    ...
    private String getMemKeyForConfigEntity(Key key) {
        return new StringBuilder().append(CONFIGURATION_ENTITY_KIND).append(KeyFactory.keyToString(key)).toString();
    }
