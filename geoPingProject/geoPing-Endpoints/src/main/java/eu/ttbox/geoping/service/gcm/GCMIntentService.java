...
public class GCMIntentService extends GCMBaseIntentService {
    ...
    public static final String INTENT_EXTRA_WATCH_UPDATE = "gcm_watch_update";
    /**
    ...
    public void onMessage(Context context, Intent intent) {
        ...
        //notifyStatusBar(intent.getStringExtra("message"));
        //System.out.println("hello what up dog");
        /*sendNotificationIntent(
                context,
