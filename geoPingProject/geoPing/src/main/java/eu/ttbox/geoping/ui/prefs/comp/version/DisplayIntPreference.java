 ...
 */
public class DisplayIntPreference extends Preference {

	private int mClickCounter;

	// This is the constructor called by the inflater
	public DisplayIntPreference(Context context, AttributeSet attrs) {
		super(context, attrs);
		setWidgetLayoutResource(R.layout.prefs_version);
	}
	...
	protected void onBindView(View view) {
		...
		final TextView myTextView = (TextView) view.findViewById(R.id.prefs_version_textView);
		if (myTextView != null) {
