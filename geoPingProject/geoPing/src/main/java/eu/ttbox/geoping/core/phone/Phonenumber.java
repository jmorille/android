...
public final class Phonenumber {
    ...
    public static class PhoneNumber implements Serializable {
        ...
        public boolean exactlySameAs(PhoneNumber other) {
            ...
            return (countryCode_ == other.countryCode_ && nationalNumber_ == other.nationalNumber_ && extension_.equals(other.extension_) && italianLeadingZero_ == other.italianLeadingZero_
                    && rawInput_.equals(other.rawInput_) && countryCodeSource_ == other.countryCodeSource_ && preferredDomesticCarrierCode_.equals(other.preferredDomesticCarrierCode_) && hasPreferredDomesticCarrierCode() == other
        ...
        @Override
        public int hashCode() {
            // Simplified rendition of the hashCode function automatically
            // generated from the proto
            // compiler with java_generate_equals_and_hash set to true. We are
            // happy with unset values to
            // be considered equal to their explicitly-set equivalents, so don't
            // check if any value is
            // unknown. The only exception to this is the preferred domestic
            // carrier code.
            int hash = 41;
