...
public class MapTileDownloaderTTbox extends MapTileModuleProviderBase {
	...
	private static final String TAG = "MapTileDownloaderTTbox";
	...
	public MapTileDownloaderTTbox(final ITileSource pTileSource) {
		this(pTileSource, null, null);
	}

	public MapTileDownloaderTTbox(final ITileSource pTileSource, final IFilesystemCache pFilesystemCache) {
		this(pTileSource, pFilesystemCache, null);
	}

	public MapTileDownloaderTTbox(final ITileSource pTileSource, final IFilesystemCache pFilesystemCache, final INetworkAvailablityCheck pNetworkAvailablityCheck) {
	...
	protected Runnable getTileLoader() {
		return tileLoader; // new TileLoader();
	};
