...
public abstract class MessageEncryption {
    ...
    /**
     * Encrypt a message using AES with a secrey key, generated by the
     * Diffie-Hillman algorithm with our private key and the receiver's public
     * key. The keys need to be stored locally.
     * 
     * @param context
     * @param number
     * @param text
    ...
    public static byte[] encrypt(Context context, String number, String text) throws Exception {
        ...
        return encrypt(context, privateKey, publicKey, text);
    }

    public static byte[] encrypt(Context context, PrivateKey privateKey, PublicKey publicKey, String text) throws Exception {
    ...
    /**
     * Decrypt a message using AES with a secrey key, generated by the
     * Diffie-Hillman algorithm with our private key and the receiver's public
     * key. The keys need to be stored locally.
     * 
     * @param context
    ...
    public static String decrypt(Context context, PrivateKey privateKey, String number, byte[] cipherText) throws Exception {
        PublicKey publicKey = MessageEncryptionFactory.getPublicKey(context, number);
        return decrypt(context, privateKey, publicKey, cipherText);
    }

    public static String decrypt(Context context, PrivateKey privateKey, PublicKey publicKey, byte[] cipherText) throws Exception {
        if (privateKey == null || publicKey == null) {
            return context.getString(R.string.geoping_encrypted_message);
        }
