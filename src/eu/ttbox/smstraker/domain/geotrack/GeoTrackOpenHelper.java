...
import eu.ttbox.smstraker.domain.geotrack.GeoTrackDatabase.GeoTrackColumns;
...
public class GeoTrackOpenHelper extends SQLiteOpenHelper {
	...
	public GeoTrackOpenHelper(Context context, String name, CursorFactory factory, int version) {
