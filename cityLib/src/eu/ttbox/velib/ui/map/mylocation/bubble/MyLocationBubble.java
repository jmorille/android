package eu.ttbox.velib.ui.map.mylocation.bubble;
...
public class MyLocationBubble extends FrameLayout  {
	...
	public MyLocationBubble(Context context) {
		...
		View v = inflater.inflate(R.layout.dialog_mylocation, layout);
		
		
		// Init fields
		this.coordTextView = (TextView) v.findViewById(R.id.dialog_mylocationView_coord);
		this.accuracyTextView = (TextView) v.findViewById(R.id.dialog_mylocationView_accuracy);
		this.addressTextView = (TextView) v.findViewById(R.id.dialog_mylocationView_address);
		this.altitudeTextView = (TextView) v.findViewById(R.id.dialog_mylocationView_altitude);
		this.altitudeBlock = v.findViewById(R.id.dialog_mylocationView_block_altitude);
		this.speedTextView = (TextView) v.findViewById(R.id.dialog_mylocationView_speed);
		// Frame
