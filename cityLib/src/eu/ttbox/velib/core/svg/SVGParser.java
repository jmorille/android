...
public class SVGParser {
    ...
    private static void drawArc(Path path, double x0, double y0, double x, double y, double rx, double ry, double angle, boolean largeArcFlag, boolean sweepFlag) {
        double dx2 = (x0 - x) / 2.0;
        double dy2 = (y0 - y) / 2.0;
    ...
    private static Float getFloatAttr(String name, Attributes attributes, Float defaultValue) {
        ...
        if (v == null) {
            ...
            if (v.endsWith("px")) {
                ...
                // TODO v = v.substring(0, v.length() - 1);
                v = "256";
            }
    ...
    private static class SVGHandler extends DefaultHandler {
        ...
        public void startElement(String namespaceURI, String localName, String qName, Attributes atts) {
            ...
            if (localName.equals("svg")) {
                ...
                for (int i = 0; i < atts.getLength(); i++) {
                    ...
                    if (!"x".equals(attrQName) && !"y".equals(attrQName) && !"width".equals(attrQName) && !"height".equals(attrQName) && !"xlink:href".equals(attrQName)
        ...
        public void endElement(String namespaceURI, String localName, String qName) {
            /*
             * parsed.append("</"); parsed.append(localName);
             * parsed.append(">");
             */
